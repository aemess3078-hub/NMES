export default function Page() {
  return (
    <div className="p-6 space-y-2">
      <h1 className="text-[26px] font-semibold text-foreground">기계 비가동 시간</h1>
      <p className="text-[14px] text-muted-foreground">LMS &gt; 설비 통계분석</p>
      <div className="mt-8 p-8 rounded-lg border border-dashed border-border bg-muted/20 text-center">
        <p className="text-[15px] text-muted-foreground">설비별 비가동 시간 분석 및 원인 통계 화면입니다.</p>
