export default function Page() {
  return (
    <div className="p-6 space-y-2">
      <h1 className="text-[26px] font-semibold text-foreground">현황모니터링</h1>
      <p className="text-[14px] text-muted-foreground">LMS &gt; 설비 모니터링</p>
      <div className="mt-8 p-8 rounded-lg border border-dashed border-border bg-muted/20 text-center">
        <p className="text-[15px] text-muted-foreground">설비 가동 상태 실시간 현황 모니터링 화면입니다.</p>
