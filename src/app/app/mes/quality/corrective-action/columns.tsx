...
import type { DefectCorrectiveActionRow } from "@/lib/actions/defect-corrective-action.actions"

export type { DefectCorrectiveActionRow }

export const STATUS_CONFIG: Record<
  DefectCorrectiveActionRow["status"],
...
export function getColumns(onViewDetail: (row: DefectCorrectiveActionRow) => void): ColumnDef<DefectCorrectiveActionRow>[] {
  return [
    {
    ...
    },
    {
      ...
      header: "조치내용",
      cell: ({ row }) => (
        <p className="max-w-[220px] truncate text-[13px]" title={row.original.actionContent}>
          {row.original.actionContent}
        </p>
      ),
    },
    {
