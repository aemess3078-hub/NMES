export default function Page() {
  return (
    <div className="p-6 space-y-2">
      <h1 className="text-[26px] font-semibold text-foreground">납품현황</h1>
      <p className="text-[14px] text-muted-foreground">MES &gt; 영업관리</p>
      <div className="mt-8 p-8 rounded-lg border border-dashed border-border bg-muted/20 text-center">
        <p className="text-[15px] text-muted-foreground">납품 처리된 출하 건 현황 및 납기 준수율 조회 화면입니다.</p>
