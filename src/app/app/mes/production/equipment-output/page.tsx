export default function Page() {
  return (
    <div className="p-6 space-y-2">
      <h1 className="text-[26px] font-semibold text-foreground">설비별생산현황</h1>
      <p className="text-[14px] text-muted-foreground">MES &gt; 생산관리</p>
      <div className="mt-8 p-8 rounded-lg border border-dashed border-border bg-muted/20 text-center">
        <p className="text-[15px] text-muted-foreground">설비 단위로 집계된 생산 실적 및 가동 현황 조회 화면입니다.</p>
